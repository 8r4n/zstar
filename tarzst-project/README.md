# tarzst — Secure, Verifiable Tar + Zstd Archiving

[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![Bash Version](https://img.shields.io/badge/bash-%3E%3D4.0-blue)](https://www.gnu.org/software/bash/)

`tarzst` is a command-line utility that wraps `tar`, `zstd`, and `GPG` into a single script for creating compressed, integrity-verified, and optionally encrypted archives. Every archive is accompanied by a self-contained decompression script that handles checksum verification, GPG decryption, signature checking, and extraction automatically.
